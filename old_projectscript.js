var map = null;
var colormap;
var d1 = {}, d2 = {}; // GLOBALI SOLO PER TEST
var factor = "gii";
...
function get_GII_data(data) {
	...
	for (d in data) {
        ...
        d2[a] = {fillkey: a, GII2013: b};						// dizionario 2: ISO3 -> fillkey: ISO3, GII2013: valore
	}
				...
				popupTemplate: function(geography, data) {
					...
					for (d in data) {
						if (data.fillkey == geography.id) {
							...
							//return '<div class="hoverinfo">' + geography.properties.name + ' <br> GII2013: ' + data.GII2013 + ' '
							return '<div class="hoverinfo">' + geography.properties.name + ' <br> GII2013: ' + value_print + ' '
						}
					}
